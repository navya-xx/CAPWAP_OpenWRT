...
/* Mauro: preleva il byte piu' significativo del sottocampo Data */
	...
	/************************************************************************
	 * 2015 Update:															*
	 * For distinguish between the Three types of "specials" data messages	*
	 * (Station Info, QoS stats and Frequency Stats) following values:		*
	 * 		dataRate == 255 && SNR = 2 -> Station Info Packet				*
