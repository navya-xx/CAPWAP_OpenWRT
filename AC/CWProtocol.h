...
CWBool CWAssembleMessageNew(CWProtocolMessage **completeMsgPtr, int *fragmentsNumPtr, int PMTU, int seqNum, int msgTypeValue, char *msgElemsBinding, const int msgElemBindingNum, const int msgElemBindingLen, int is_crypted);
